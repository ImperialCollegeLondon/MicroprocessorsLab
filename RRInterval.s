...
global	no_overflow, overflow, Sixteen_Division
...
;	movlw	0x00
;	banksel CCPTMRS1
;	movwf	CCPTMRS1,B    ;sets CCP5 to use timer1 for capture
;	movlw	00111111B    ;enables Timer1 to synchronise with external clock at RA5 and perform read/write in 1 16bit operation
;	movwf	T1CON
;	bsf	PIE4, 2	    ;enables CCP5 interrupt
;	bcf	PIE1, 0	    ;enables timer1 overflow interrupt
;	bsf	IPR4, 2    ;timer 1
;	;bsf	ODCON2, 2
;	movlw	0x00 
;	movwf	TRISF
...
;	movlw   0xff
;	movwf   LATF, A
;	bcf	PIR4, 2	    ;Checks to see if timer1 overflowed
;	retfie	f
;	bra	no_overflow
;	bra	overflow
